\chapter{Introducción. ¿Con qué trabajo en un SIG?}\label{Introduccion_datos}
\pagestyle{fancy}

\begin{keypoints}
¿Qué papel juegan los datos en un SIG? $\bullet$ ¿Qué aspectos son destacables acerca de los datos espaciales? $\bullet$ ¿Qué diferencia existe entre datos e información? $\bullet$ ¿Qué componentes tiene la información espacial? $\bullet$ ¿Cómo se divide y estructura la información espacial? 
\end{keypoints}
...
\section{Las componentes de la información geográfica}\label{ComponenteInformacionGeografica}
...
\begin{itemize}
 ...
 \item Numérica. A su vez, pueden señalarse los siguientes grupos:\index{Información!numérica}
	\begin{itemize}
	\item Nominal. El valor numérico no representa sino una identificación. Por ejemplo, el número de un portal en una calle, o el numero del DNI de una persona. Este tipo de variable, al igual que la de tipo alfanumérico, es de tipo cualitativo, frente a las restantes que son de tipo cuantitativo.\index{Nominal}
	\item Ordinal. El valor numérico establece un orden. Por ejemplo, una capa en la que se recoja el año de fundación de las distintas ciudades contenidas en ella.\index{Ordinal}
	\item Intervalos. Las diferencias entre valores de la variable tienen un significado. Por ejemplo, entre dos valores de elevación.\index{Intervalos}
	...
	\end{itemize}
\item Alfanumérica\index{Información!alfanumérica}
\end{itemize}
...
\section{División horizontal de la información geográfica}\label{divisionHorizontal}
