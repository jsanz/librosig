\chapter{Análisis multidimensional}\label{Analisis_multidimensional}

\begin{keypoints}
¿Cómo se incorpora el análisis multidimensional en los SIG? $\bullet$ ¿Qué nuevos usos permite?  $\bullet$ ¿En qué campos se puede aplicar especialmente el análisis tridimensional? $\bullet$ ¿Y el análisis temporal? $\bullet$ ¿Qué problemas aparecen?
\end{keypoints}
