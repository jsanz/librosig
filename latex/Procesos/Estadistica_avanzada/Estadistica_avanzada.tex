...
\begin{keypoints}
¿Cómo puede convertirse un conjunto de capas en una capa con información categórica?$\bullet$ ¿Cómo eliminar la redundancia que presentan habitualmente las imágenes multiespectrales? $\bullet$ ¿Qué diferencia existe entre la clasificación supervisada y no supervisada?$\bullet$¿Cómo evaluar la bondad de una clasificación?$\bullet$¿Cómo incorporar las particularidades de los datos espaciales en un análisis de regresión? $\bullet$  ¿Que otras formulaciones además de las que conocemos existen para poder combinar distintas capas representando distintos criterios acerca de un fenómeno dado? 
\end{keypoints}
...
\subsubsection{Paralelepípedos}\label{Paralelepipedos}
...
\begin{equation}\label{Eq:Matriz_covarianzas}
C = \left(
\begin{array}{cccc}
...
\subsection{Clasificación no supervisada}\label{Clasificacion_no_supervisada}
...
\begin{figure}[!hbt]
\centering
\includegraphics[width=.4\mycolumnwidth]{Estadistica_avanzada/Cluster_jerarquico.pdf}
...
%\begin{figure}[!hbt]
%\centering
%\includegraphics[width=.9\mycolumnwidth]{Estadistica_avanzada/Soft_classification.png}
%\caption{\small Capas de probabilidad correspondientes a las tres clases de usos de suelo definidas, como resultado de un proceso de clasificación débil.}
...
\begin{equation}\label{Eq:Regresion_multiple}
...
\subsection{Creación de capas a combinar}\label{Creacion_capa_combinar}
...
\section{Análisis de Componentes Principales}\label{Componentes_principales}
...
%Como ejemplo de aplicación de esta técnica, la figura \ref{Fig:PCA} muestra la reducción de las capas de una imagen LANDSAT\index{LANDSAT} TM+ a tres únicas bandas.\index{LANDSAT}
%
%\begin{figure}[!hbt]
%\centering
%\includegraphics[width=.95\textwidth]{Estadistica_avanzada/PCA.png}
%\caption{\small Reducción de un conjunto de bandas procedentes de un sensor LANDSAT TM+ a un conjunto de tres bandas, mediante el uso de Componentes Principales .}
%\label{Fig:PCA}
%\end{figure}
