...
\begin{keypoints}
¿Qué diferencia al dato espacial de otro tipo de datos? $\bullet$ ¿Cómo puedo sacar provecho de esas particularidades? $\bullet$ ¿Qué implicaciones tienen las características del dato espacial a la hora de su análisis? $\bullet$ ¿Qué es la autocorrelación espacial? $\bullet$ ¿Qué es el \emph{Problema de la Unidad de Área Modificable}? $\bullet$ ¿Cuáles son las relaciones fundamentales que existen entre entidades espaciales?
\end{keypoints}
...
\subsection{Escala}\label{Escala_analisis}
...
\begin{figure}[h]   
\centering
\includegraphics[width= .4\mycolumnwidth]{Analisis_espacial/Estructura_escalas.pdf}
...
\subsection{El \emph{Problema de la Unidad de Área Modificable}}\label{MAUP}
...
% \begin{figure}[h]   
% \centering
% \includegraphics[width=.textwidth]{Analisis_espacial/Autocorrelacion_escala.png}
% \caption{\small El signo de la autocorrelación puede variar con la escala. Según el tamaño de la unidad de análisis se obtendran las mallas ráster de altura media representadas en la parte derecha, cada una de ellas con un tipo de autocorrelación espacial distinto.}
% \label{Fig:Autocorrelacion_escala} 
% \end{figure}
...
\subsection{Efectos de borde}\label{EfectoBorde}
...
\section{Algunos cálculos espaciales básicos}\label{Calculos_espaciales_basicos}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.5\mycolumnwidth]{Analisis_espacial/Distancia_raster.pdf}
...
\begin{equation}\label{Eq:Area_poligono}
...
\section{Relaciones espaciales}\label{Relaciones_espaciales}
...
Por ejemplo, la \emph{relación de subdivisión del área interior} (\emph{internal areasplitting ratio(IAR)}), (Figura \ref{Fig:Internal_area_splitting}), se define cómo el mínimo área de las dos que quedan a cada uno de los lados de la línea dentro de la región, dividido por el área total de región.\index{Relación!de subdivisión del área interior}\index{Internal areasplitting ratio}
...
\begin{figure}[h]   
\centering
\includegraphics[width=.23\mycolumnwidth]{Analisis_espacial/Internal_area_splitting.pdf}
\caption{\small Esquema de la forma en que una línea divide a una región. La menor de las dos (en oscuro), dividida por el área total, define la \emph{relación de subdivisión del área interior}. }
\label{Fig:Internal_area_splitting} 
\end{figure}
