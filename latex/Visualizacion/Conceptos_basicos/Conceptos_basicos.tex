\chapter{Conceptos básicos de visualización y representación}\label{Conceptos_basicos_visualizacion}

\begin{keypoints}
¿Qué debemos conocer para representar la información geográfica de la mejor manera posible? $\bullet$ ¿Qué es el lenguaje visual? $\bullet$ ¿Qué son las variables visuales? $\bullet$ ¿Qué variables visuales existen? $\bullet$ ¿Cómo afectan a los distintos elementos gráficos con que componemos un mapa? $\bullet$ ¿Qué propiedades tienen?
\end{keypoints}
...
\caption{\small Espacio de color HSV explicando el significado de las componentes tono, valor y saturación (adaptado de Wikipedia).}
\label{Fig:HSV} 
\end{figure}
...
\begin{itemize}
	\item Asociativa. Una variable visual presenta la propiedad asociativa si al ser aplicada no aumenta ni disminuye la visibilidad de un elemento. Es decir, cuando en función de esa variable visual no puede asignársele más o menos importancia a este.
	\item Selectiva. La propiedad selectiva la presentan aquellas variables visuales que, al ser aplicadas, generan distintas categorías de símbolos.
	...
	\item Cuantitativa. Cuando, además del orden, una variable puede mostrar cantidades o proporciones, entonces se dice que posee la propiedad cuantitativa.
\end{itemize}
...
\subsection{Ayudas a la percepción}\label{AyudasPercepcion}
