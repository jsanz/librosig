...
\begin{keypoints}
¿Qué es una infraestructura de datos espaciales? $\bullet$ ¿Por qué surgen las Infraestructuras de Datos Espaciales? $\bullet$ ¿Qué elementos son importantes para el establecimiento de una?$\bullet$¿Qué niveles existen dentro de una Infraestructura de Datos Espaciales?
\end{keypoints}
...
\begin{figure}[!hbtp]   
	...
	\caption{\small Clasificación de usuarios de una IDE (según \cite{Rodriguez2005JIDEE})}\label{Fig:UsuariosIDE} 
\end{figure}
...
\begin{figure}[!hbtp]   
	...
	\caption{\small Interfaz de acceso al catálogo de la IDE de la Universidad de Extremadura}\label{Fig:Catalogo_UNEX} 
\end{figure}
