...
.. figure:: Herramientas_navegacion.png
...
Estándares para el almacenamiento de estilos como SLD(\extr{Styled Layer Descriptor}), que veremos en detalle en el apartado \ref{SLD}, tienen como objeto solventar este problema. 
