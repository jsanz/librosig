...
De entre estos, algunos son considerados como fundamentales y se incluyen de forma genérica, mientras que otros pueden o no incorporarse. Al definir una especificación de metadatos, se pueden establecer niveles de prioridad, estableciéndose un grupo de propiedades básicas que han de documentarse siempre y otro con propiedades de carácter opcional.% (Figura :num:`#figcontenidometadatos`).
