...
%.. figure:: imagenes/ComponentesIDE.png
%	
	Componentes de una IDE
...
%Los actores involucrados en el funcionamiento de una IDE son varios, tal y como se puede observar en la figura :num:`#figactoreside`.

%.. figure:: imagenes/ActoresIDE.png
%	
	Actores de una IDE
...
.. figure:: usuariosIDE.pdf
	
	Clasificación de usuarios de una IDE (según \cite{Rodriguez2005JIDEE)}
...
.. figure:: EvolucionINSPIRE.pdf
	
	Secuencia temporal seguida por INSPIRE (adaptado de \cite{Craglia2009INSPIRE)}
...
.. figure:: EjemploIDE.pdf
	
	Ejemplo de estructura a distintos niveles para una IDE particular (IDE de Pamplona) (adaptado de \cite{Echeverria2001Boletic)}
