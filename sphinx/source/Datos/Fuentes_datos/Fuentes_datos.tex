...
.. _Fig:Radiacion_electromagnetica: 
...
.. _Fig:Espectro_electromagnetico: 
...
Dentro de estas regiones, son de destacar las siguientes:
	...
	* Visible (0.3 :math:`\mu` - 0.7 :math:`\mu`). Se corresponde con las radiaciones que pueden ser detectadas por el ojo humano o por aparatos tales como una cámara fotográfica común. Observando la figura \ref{Fig:Espectro_electromagnetico} puede apreciarse que esta región representa una porción muy pequeña del total del espectro. Existen muchas otras regiones que no podemos <<ver>> pero que, empleando la tecnología adecuada, sí que pueden aprovecharse para crear imágenes dentro de un proceso de teledetección, siendo de gran utilidad para el estudio de numerosos procesos.
...
.. _Fig:Digitalizacion_en_pantalla: 
...
.. _Fig:Correccion_digitalizacion: 
...
.. _Fig:Estacion_fotogrametrica_digital: 
...
.. _Fig:Imprecisiones_digitalizacion: 
