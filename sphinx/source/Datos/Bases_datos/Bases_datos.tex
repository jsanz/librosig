...
El cuadro :ref:`Tabla:TerminologiaModeloRelacional` muestra un resumen de algunas de las equivalencias entre la terminología habitual y la específica del modelo relacional. En la figura :num:`#figelementosmodelorelacional` puede verse un esquema de los elementos fundamentales del modelo relacional.
...
``Nombre`` & ``Habitantes`` & ``Superficie(:math:`km^2`)`` \\ \midrule
Madrid & 6386932 & 607	 \\ 
...
\end{center}
	...
	La información de las tablas ``PERSONAS y \texttt{CIUDADES`` puede recogerse en una única tabla como la mostrada.}
