...
.. figure:: ComparacionModelos.pdf

	Comparación entre algunos modelos de base de datos más frecuentes (adaptado de \cite{USDT2001).}


.. _Fig:Comparacion_BBDD: 
...
\end{tabular}
	...
	Terminología del modelo relacional (Adaptado de \cite{Date1986BBDD).}


.. _Tabla:TerminologiaModeloRelacional:
\end{table}

.. figure:: ElementosModeloRelacional.pdf

	Elementos del modelo relacional.


.. _Fig:ElementosModeloRelacional: 
...
\textsc{Nombre} & \textsc{Habitantes} & \textsc{Superficie(:math:`km^2`)} \\ \midrule
Madrid & 6386932 & 607	 \\ 
...
\end{center}
	...
	La información de las tablas \texttt{PERSONAS y \texttt{CIUDADES} puede recogerse en una única tabla como la mostrada.}


.. _Tabla:TablaConjunta:
\end{table*}
