...
.. figure:: MapaCosecha.pdf

	Mapa de productividad de una cosecha generado mediante elementos SIG a bordo de una cosechadora (adaptado de \cite{SearcyPrecisionFarming).}
...
.. _Fig:MaquinariaAgriculturaPrecision:
...
Haciendo más general el problema para la instalación de un número :math:`k` de nuevas instalaciones, podemos expresar este como el de minimizar la siguiente función \cite{Bosque2004Rama}:
