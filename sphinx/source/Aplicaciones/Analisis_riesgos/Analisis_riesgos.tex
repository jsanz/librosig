...
%La figura :num:`#figesquemadelimitacionzonasinundacion` muestra una visión esquemática de todo el proceso tratado en esta sección, en el que puede verse cómo desde los datos de partida se alcanza un resultado cartográfico final en el cual puede ya interpretarse los riesgos de avenidas que un evento dado comporta. Se han señalado aquellas partes del proceso donde la utilización de un SIG aporta mayores ventajas con respecto a la metodología clásica.
%
...
.. _figesquema_delimitacion_zonas_inundacion:
%
...
A pesar de todo ello, las capacidades SIG de estos programas no son tan versátiles como las de un SIG genérico, y el uso de los mismos queda muy restringido al propio estudio de procesos hidrológicos e hidráulicos. %La figura :num:`#figmike` muestra el aspecto de una de estas aplicaciones.
