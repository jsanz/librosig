\chapter{Costes, distancias y áreas de influencia}\label{Costes}

\begin{keypoints}
¿Qué es una superficie de fricción? $\bullet$ ¿Cómo calcular un capa de coste acumulado? $\bullet$ ¿Cuál es la diferencia entre un modelo de coste acumulado isotrópico y uno anisotrópico? $\bullet$ ¿Cómo combinar varias superficies de fricción en una única? $\bullet$ ¿Cómo calcular una ruta óptima sobre una superficie de coste acumulado? $\bullet$ ¿Y sobre una red con topología? $\bullet$ ¿Cómo se define una zona de influencia sobre una capa ráster?
\end{keypoints}
...
\begin{figure}[h]   
\centering
\includegraphics[width=.4\textwidth]{Costes/Ejemplo_superficie_friccion.pdf}
...
\section{Cálculo de rutas óptimas}\label{Rutas_optimas}
...
\section{Zonas de influencia}\label{Zona_influencia_raster}
...
\subsection{Zonas de influencia de dimensión fija}\label{Zonas_influencia_dimension_fija}
...
%\begin{figure}[h]   
%\centering
%% \includegraphics[width=.5\mycolumnwidth]{Zona_influencia_calado.png}
%\caption{\small Zona de inundación calculada a partir de los valores de calado en cada celda de cauce.}
%\label{Fig:Zona_influencia_calado} 
%\end{figure}
...
%La figura \ref{Fig:Influencia_ciudades_pesca} muestra un esquema gráfico de este proceso.
%
%
%\begin{figure}[h]   
%\centering
%\includegraphics[width=.7\mycolumnwidth]{Influencia_ciudades_pesca.png}
%\caption{\small Proceso de cálculo de la influencia global de un conjunto de núcleos poblacionales sobre un cauce.}
%\label{Fig:Influencia_ciudades_pesca} 
%\end{figure}


\section{Análisis de redes}\label{Analisis_redes}
...
También en cierta forma relacionado con los problemas anteriores, un enunciado clásico con gran aplicación en el ámbito SIG es el conocido como \emph{problema del viajante} o TSP\footnote{\extr{Travelling Salesman Problem}}. Dado un conjunto de puntos, se trata de calcular la forma de visitar todos ellos en un orden dado y regresando al punto inicial, de tal modo que el recorrido total tenga la mínima longitud posible.
