\chapter{Introducción. ¿Qué puedo hacer con un SIG?}\label{Introduccion_procesos}
\pagestyle{fancy}

\begin{keypoints}
¿Qué puedo hacer con los datos espaciales en un SIG? $\bullet$ ¿Qué tipo de respuestas pueden proporcionarme esos datos? $\bullet$ ¿Cuales son los límites del análisis espacial? $\bullet$ ¿Cómo puedo sacar el máximo partido a la información espacial para un objetivo concreto? 
\end{keypoints}
...
\item Transformaciones. Podemos englobar dentro de este grupo una amplia serie de procedimientos que modifican los elementos de entrada de diversas formas.
...
\item Inferencia. Otro análisis estadístico de gran importancia en los SIG es el que permite inferir comportamientos de las distintas variables y estudiar, por ejemplo, la forma en que estas van a evolucionar a lo largo del tiempo.
...
\item Modelización. La creación de modelos espaciales dentro de un SIG es una tarea aún pendiente de mucho desarrollo. No obstante, existe un gran número de modelos en los más diversos campos, y la arquitectura de datos y procesos de los SIG es propicia para la implementación de otros nuevos.
