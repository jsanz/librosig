\chapter{La visualización en términos SIG}\label{Visualizacion_SIG}

\begin{keypoints}
¿Qué parámetros puedo configurar en la representación de una capa vectorial? $\bullet$ ¿Y de una capa ráster? $\bullet$ ¿Cómo puedo combinar varias capas de la mejor forma posible? $\bullet$ ¿Cómo elaboro una vista tridimensional? $\bullet$ ¿Qué otros elementos pueden emplearse para enriquecer una representación en un SIG?
\end{keypoints}
...
%\caption{\small Combinación de imágenes incompletas mediante uso de transparencias en zonas sin datos.}
%\label{Fig:DiferenciaCombinacionCapas} 
%\end{figure}
...
\begin{itemize}
	\item Momento. El equivalente a la variable visual posición, indica el momento en la animación en que se produce un cambio de una escena a otra.
	\item Frecuencia. Indica la velocidad a la que se produce el cambio en la animación. Si es demasiado lenta, puede aportar una longitud excesiva a esta, mientras que si es demasiado rápida puede hacer difícil analizar e interpretar el cambio que se produce.
	\item Duración. El tiempo que cada escena se encuentra visible, que no tiene que ser el mismo para todas ellas.
	\item Magnitud del cambio. Indica cuánto cambia una escena respecto a la anterior. Si es pequeño, la animación sera fluida, mientras que si es muy elevado, la animación tendrá saltos bruscos. Dividido por la duración nos indica la \emph{tasa de cambio}.
	\item Orden. La posición de cada escena dentro del conjunto, estableciendo antes o después de cuáles de las restantes aparece.
	\item Sincronización. Si la animación muestra la variación de varias variables, establece cómo el cambio en estas se encuentra relacionado. Una correcta sincronización ayuda a interpretar la relación que puede existir entre las variables que varían en la animación.
\end{itemize}
...
\end{figure}
	...
	\item Vídeos. Del mismo modo que las fotografías, aportan más información sobre la zona representada y permiten una exploración mayor. Aunque son una tecnología aún muy experimental, existen también vídeos de tipo inmersivo.
	\item Sonido. Los elementos no han de ser necesariamente visuales, sino que pueden proporcionar información a través de otros sentidos distintos.
	\item Documentos. Un SIG puede incorporar documentos complejos tales como páginas Web o textos varios.
\end{itemize}
