\chapter{Análisis y gestión de riesgos}\label{Analisis_riesgos}

\begin{keypoints}
¿Cómo pueden contribuir los SIG a la prevención de riesgos? $\bullet$ ¿Qué riesgos y amenazas naturales pueden modelizarse dentro de un SIG? $\bullet$ ¿Qué técnicas se emplean para ello?
\end{keypoints}
...
\item Variables no geográficas. El tipo de vegetación o la temperatura del agua son algunas de las variables de este grupo que tienen influencia sobre las variables climatológicas. La teledetección es en este caso una fuente de datos de primer orden, ya que permite obtener las capas correspondientes a estos predictores. El uso de índices de vegetación es habitual en este sentido.
\end{itemize}
...
%\begin{figure}[!hbt]   
%\centering
%	\includegraphics[width=.8\textwidth]{Analisis_riesgos/Esquema_delimitacion_zonas_inundacion.pdf}
%\caption{\small  Esquema funcional del proceso de delimitación de zonas de inundación, señalando aquellos pasos en los que el empleo de SIG resulta más relevante.}
%\label{Fig:Esquema_delimitacion_zonas_inundacion}
%\end{figure}
...
%\begin{figure}[!hbt]   
%\centering
%\includegraphics[width=.8\textwidth]{Analisis_riesgos/Mike.png}
%\caption{\small  Interfaz de usuario de MIKE, una aplicación para análisis hidrológico e hidráulico con elementos SIG.}
%\label{Fig:Mike}
%\end{figure}
