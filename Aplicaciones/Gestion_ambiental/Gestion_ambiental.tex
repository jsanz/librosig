\chapter{Gestión de recursos y planificación}\label{Gestion_ambiental}

\begin{keypoints}
¿Cómo ayuda un SIG a la gestión de los recursos energéticos? $\bullet$ ¿Y a la gestión de un monte? $\bullet$ ¿Qué papel juegan los SIG en la planificación y gestión territorial? $\bullet$ ¿Qué modelos son aplicables en este sentido? $\bullet$ ¿Cómo se modeliza el cambio en los usos de suelo de una zona? $\bullet$ ¿Qué es un modelo de localización óptima?
\end{keypoints}
...
\subsection{Modelización de usos del suelo}\label{Cambio_usos_suelo}
...
\section{Modelos de localización óptima}\label{Localizacion_optima}
