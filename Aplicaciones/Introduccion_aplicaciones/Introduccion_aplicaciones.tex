\chapter{Introducción. ¿Para qué puedo utilizar un SIG?}\label{Introduccion_aplicaciones}
\pagestyle{fancy}

\begin{keypoints}
¿En qué disciplinas puede utilizarse un SIG? $\bullet$ ¿Qué funcionalidades aporta un SIG al desarrollo de estas disciplinas?$\bullet$ ¿Qué tipos de usuarios de SIG encontramos? $\bullet$ ¿Cómo contribuyen estos usuarios a la definición y desarrollo de los SIG? 
\end{keypoints}
