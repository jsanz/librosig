\chapter{Ecología}\label{Ecologia}

\begin{keypoints}
¿Qué es la ecología del paisaje y cómo ayuda un SIG a su estudio?$\bullet$¿Cómo se emplea un SIG para modelizar una comunidad animal?$\bullet$¿Y una comunidad vegetal?$\bullet$ ¿Qué es un modelo predictivo?   
\end{keypoints}
...
\section{Modelización de hábitats. Modelos predictivos}\label{Modelos_predictivos}
